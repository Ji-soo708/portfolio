...
✔️ Post 모듈(생존/미션 게시글, 이모지) API 개발 전담
...
본 프로젝트에서는 평소 부모님께 연락하는 것이 부끄럽거나, 자주 연락하지 못하시는 분들을 위해 쉬운 방법으로 일상을 공유할 수 있는 기능을 제공합니다.`}
      ...
      <ProjectContentBox
        ...
        content={`서로 다른 도메인 간의 강력한 결합은 유지보수와 확장성 측면에서 문제를 일으킬 수 있습니다. 만약 다른 서비스의 기능이 필요할 때에는 해당 서비스에 대한 의존성을 직접 추가하면 되지만 강력한 결합을 초래할 수 있습니다. 본 프로젝트에서는 서로 다른 도메인 간의 의존성을 최소화하기 위해 \`EventListener\`를 도입했습니다. 결과적으로 도메인 간 결합도를 낮추고 두 로직을 분리하여 실행할 수 있었습니다.`}
      />
