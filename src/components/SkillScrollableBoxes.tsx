...
const boxes = [
  {
    ...
    image: SpringIcon,
    description: [
      <span style={{ color: "#6CCA4E" }} key="span1">
        DataJPA
      </span>,
      "를 이용하여",
      <br key="br1" />,
      <span style={{ color: "#6CCA4E" }} key="span2">
        객체 지향 프로그래밍
      </span>,
      "을",
      <br key="br2" />,
  ...
  },
  {
    ...
    description: [
      "자바의 장점을 살려,",
      <br key="br1" />,
      <span style={{ color: "#EA2D2E" }} key="span1">
        클린코드
      </span>,
      "를",
      <br key="br2" />,
  ...
  },
  {
    ...
    description: [
      "CRUD를 넘어,",
      <br key="br1" />,
      <span style={{ color: "#39ADB5" }} key="span1">
        DB에서의 성능 최적화
      </span>,
      "를",
      <br key="br2" />,
  ...
  },
  {
    ...
    image: ReactIcon,
    description: [
      <span style={{ color: "#61DAFB" }} key="span1">
        컴포넌트 기반 구조
      </span>,
      "의",
      <br key="br1" />,
