...
const boxes = [
  { id: 1, tag: 'Depromeet 14th', name: 'Bibbi', image: Bibbi, description: '하루 한 번, 가족에게 보내는 생존신고<br />삐삐', color: '#1D1D1F', link: '/projects/bibbi' },
  { id: 2, tag: 'Konkuk Univ.', name: 'Mocacong', image: Mocacong, description: '코딩하기 좋은 카페를 찾고 싶다면<br />모카콩', color: '#1D1D1F', link: '/projects/mocacong' },
  { id: 3, tag: '10th 9oormthon in Jeju', name: '바로깅', image: Baroging, description: '제주 해안 생태계 보전을<br />위한 플로깅 서비스<br />바로깅', color: '#FFFFFF', link: '/projects/baroging' },
];
